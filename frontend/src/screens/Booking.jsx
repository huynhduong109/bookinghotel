                            ...
                            <div className="mx-auto px-4 md:px-10 lg:px-20 xl:px-48 mt-4 flex flex-col md:flex-row  md:justify-between">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="px-1 sm:px-3 py-20 flex justify-center sm:justify-end items-center ">
                                        <button onClick={onCheckout} className="py-4 w-60 block text-center rounded bg-red-400 hover:bg-red-500 transition duration-200 text-zinc-50 cursor-pointer" disabled={willCheckOut ? false : true} >Checkout</button>
                                    </div>
                                </div>
                            </div >
                        )}
